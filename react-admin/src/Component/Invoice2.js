		...
		<Header/>
            ...
            <div className="container">
                ...
                <div className="col-xs-12">
                    ...
                    <h2>Invoice</h2><h3 className="pull-right">Order # 100003</h3>
                    </div>
                    <hr />
                    <div className="row">
                    ...
                    <div className="col-xs-6 text-right">
                        ...
                        Emma Watson<br />
                        Hogwarts School of Witchcraft and Wizardy<br />
                        </address>
                    </div>
                    </div>
                    <div className="row">
                    ...
                    <div className="panel-body">
                        ...
                        <table className="table table-condensed">
                            ...
                            <tr>
                                ...
                                <td className="thick-line text-right">Rp 400.000</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td className="no-line text-right">Rp 450.000</td>
                            </tr>
                            </tbody>
                        </table>
                        </div>
