		...
		<Header/>
            ...
            <div className="container">
                    ...
                    <div className="col-xs-12">
                        ...
                        <h2>Invoice</h2><h3 className="pull-right">Order # 100004</h3>
                        </div>
                        <hr />
                        <div className="row">
                        ...
                        <div className="panel-body">
                            ...
                            <table className="table table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td className="text-right">Rp 200.000</td>
                                </tr>
                                <tr>
                                    <td>C-0003</td>
                                ...
                                <tr>
                                    ...
                                    <td className="thick-line text-right">Rp 350.000</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td className="no-line text-right">Rp 400.000</td>
                                </tr>
                                </tbody>
                            </table>
                            </div>
