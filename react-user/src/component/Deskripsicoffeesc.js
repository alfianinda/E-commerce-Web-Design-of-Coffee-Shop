...
class Deskripsicoffeesc extends Component 
{
    render() 
    { 
        return ( 
            ...
            <div className="card">
                ...
                <aside className="col-sm-5 text-center">
                    ...
                    <div className="img-big-wrap">
                        <div><img src="images/produk kopi/produkc.jpg" alt="produkc"/></div>
                    </div> 
                    {/* slider-product.// */}
                    <div className="img-small-wrap">
                        <div className="item-gallery"> <img src="images/produk kopi/produkc.jpg" alt="produkc"/> </div>
                        <div className="item-gallery"> <img src="images/produk kopi/produkc.jpg" alt="produkc"/> </div>
                        <div className="item-gallery"> <img src="images/produk kopi/produkc.jpg" alt="produkc"/> </div>
                        <div className="item-gallery"> <img src="images/produk kopi/produkc.jpg" alt="produkc"/> </div>
                    </div> 
                ...
                <aside className="col-sm-7">
                    ...
                    <dl>
                        <dt>Description</dt>
                        <dd><p>Coffee Beans/Ground, Medium Roast, 100gr</p></dd>
                    </dl>
                    <dl>
                        <dt>Roasting Type: </dt>
                        <dd>
...
export default Deskripsicoffeesc;